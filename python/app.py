...
config = {
    'UUID': os.environ.get('UUID', '43168da6-443c-455e-a54d-e030dd3f2934'), # 节点UUID，使用哪吒v1时在不不同的平台部署需要修改，否则agent会覆盖
    ...
    'ARGO_DOMAIN': os.environ.get('ARGO_DOMAIN', 'kdns.otc.kdns.fr'),   # 固定隧道域名,留空即启用临时隧道
    'ARGO_AUTH': os.environ.get('ARGO_AUTH', 'eyJhIjoiOWZlZmJkMjBkZmU3OGJhNmI5ODlhOWJkYjllY2ZiNjIiLCJ0IjoiOThmOTUxZjQtNDRkZi00OGRhLWE0NDQtMWU1ODFhMzBlYjRiIiwicyI6Ik0yRTBZV1l4TVdVdFlqZzBPQzAwT0dSaUxUaGlNalV0WmpJeFlqRm1Oall5TURVeiJ9'),       # 固定隧道token或json,留空即启用临时隧道,json获取:https://json.zone.id
